...
package mx.controls
{
    ...
    public class Menu extends List implements IFocusManagerContainer
    {
        ...
        {
            var menuListData:MenuListData = new MenuListData(itemToLabel(data), itemToIcon(data), itemToKeyEquivalent(data), labelField, "", uid, this, rowNum);
        ...
        public function itemToKeyEquivalent(data:Object):String
        {
            ...
            {
                key = "Crtl+Shift+" + key.toUpperCase();
            }
            else 
            {
                key = "Crtl+" + key.toUpperCase();
            }
