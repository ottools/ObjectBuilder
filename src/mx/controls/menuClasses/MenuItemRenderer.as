...
package mx.controls.menuClasses
{
        ...
        IFontContextComponent
    {
        ...
        /**
         *  The internal UITextField that displays the key equivalent in this renderer.
         * 
         *  @default null 
         *  
         *  @langversion 3.0
         ...
         *  @productversion Flex 3
         */
        protected var keyEquivalent : IUITextField;
         ...
         */
        private var _listData : MenuListData;
        ...
        override protected function commitProperties():void
        {
            ...
            if (hasFontContextChanged() == true)
            {
                ...
                {
                    index = getChildIndex(DisplayObject(keyEquivalent));
                    removeKeyEquivalentLabel();
                    createKeyEquivalentLabel(index);
                }
            }
            ...
            if (_data)
            {
                ...
                // Key Equivalent
                keyEquivalent.text = _listData.keyEquivalent;
                keyEquivalent.enabled = isEnabled;
        ...
        override protected function measure():void
        {
            ...
            if (_listData)
            {
                ...
                {
                    measuredWidth = label.measuredWidth + (10 + keyEquivalent.measuredWidth + 10) + leftMargin + rightMargin + 7;
                }
                else
                {
                                                      ...
                                                      unscaledHeight:Number):void
        {
            ...
            if (_listData)
            {
                ...
                keyEquivalent.x = unscaledWidth - rightMargin + (rightMargin - keyEquivalent.measuredWidth) - 20;
                ...
                if (data && parent)
                {
                    ...
                    keyEquivalent.setColor(labelColor);
                }
            }
        }
        ...
        /**
         *  @private
         *  Creates the key equivalent text field and adds it as a child of this component.
         * 
         *  @param childIndex The index of where to add the child.
         *  If -1, the text field is appended to the end of the list.
         */
        mx_internal function createKeyEquivalentLabel(childIndex:int):void
        {
            if (keyEquivalent == null)
            {
                keyEquivalent = IUITextField(createInFontContext(UITextField));			
                keyEquivalent.styleName = this;
                
                if (childIndex == -1)
                    addChild(DisplayObject(keyEquivalent));
                else 
                    addChildAt(DisplayObject(keyEquivalent), childIndex); 
            }
        }
        
        /**
         *  @private
         *  Removes the key equivalent text field from this component.
         */
        mx_internal function removeKeyEquivalentLabel():void
        {
            if (keyEquivalent != null)
            {
                removeChild(DisplayObject(keyEquivalent));
                keyEquivalent = null;
            }
        }
         ...
         *  @private
         */
        mx_internal function getKeyEquivalent() : IUITextField
        {
